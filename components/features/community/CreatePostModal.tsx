  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="w-full max-w-md rounded-xl border border-gray-200 bg-white shadow-xl flex flex-col">
        {/* Header — identical structure to CreatePageModal header */}
        <div className="flex items-center justify-between border-b border-gray-100 px-6 py-4 shrink-0">
          <div>
            <h2 className="text-lg font-medium text-gray-900">New Post</h2>
            <p className="mt-0.5 text-xs text-gray-400">
              Share an update or start a discussion with your team.
            </p>
          </div>
          <button
            onClick={handleClose}
